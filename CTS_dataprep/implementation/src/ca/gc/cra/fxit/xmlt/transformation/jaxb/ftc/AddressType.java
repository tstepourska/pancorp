...
public class AddressType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "AddressFree", namespace = "urn:oecd:ties:stffatcatypes:v1", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "CountryCode", namespace = "urn:oecd:ties:stffatcatypes:v1", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "AddressFix", namespace = "urn:oecd:ties:stffatcatypes:v1", type = JAXBElement.class, required = false)
    })
     ...
     * line 64 of file:/C:/dev/projects/ca2us2016/implementation/schema/v1.1_custom/stffatcatypes_v1.1.xsd
     * line 61 of file:/C:/dev/projects/ca2us2016/implementation/schema/v1.1_custom/stffatcatypes_v1.1.xsd
     * <p>
