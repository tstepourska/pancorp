 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ResCountryCode" type="{urn:oecd:ties:isoetrtypes:v1}CountryCode_Type" maxOccurs="unbounded"/&gt;
 *         &lt;element name="TIN" type="{urn:oecd:ties:etr:v1}TIN_Type"/&gt;
 *         &lt;element name="IN" type="{urn:oecd:ties:etr:v1}OrganisationIN_Type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Name" type="{urn:oecd:ties:etr:v1}EtrNameOrganisation_Type" maxOccurs="unbounded"/&gt;
 *         &lt;element name="Address" type="{urn:oecd:ties:etr:v1}Address_Type" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class OrganisationPartyType {
    ...
    protected List<EtrNameOrganisationType> name;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EtrNameOrganisationType }
     * 
     * 
     */
    public List<EtrNameOrganisationType> getName() {
        if (name == null) {
            name = new ArrayList<EtrNameOrganisationType>();
        }
        return this.name;
    }
