...
public class IP6MSGHD extends CobolRecord
{
	...
	public String toString(){
		...
		.append("getPrt18RtnSummTcd=").append(this.getPrt18RtnSummTcd()).append(",")
		.append("getPrt18SeqNbr=").append(this.getPrt18SeqNbr()).append(",")
		.append("getRtnTxYr=").append(this.getRtnTxYr()).append(",")
		.append("getRec=").append(this.getRec().trim()).append(",")
		.append("getRunDate=").append(this.getRunDate()).append(",")
		.append("getRunTime=").append(this.getRunTime())
		;
