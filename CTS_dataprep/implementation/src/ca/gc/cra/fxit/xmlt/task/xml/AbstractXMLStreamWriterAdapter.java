...
/**
 * This class implements XMLStreamWriter interface methods that are common for all data providers.
 * Methods omitted here must be implemented in subclass
 * 
 * This class replaces combinations of characters that are prohibited in FATCA/CRS XML data values with blank spaces.
 ...
 */
public abstract class AbstractXMLStreamWriterAdapter implements XMLStreamWriter {

	protected final XMLStreamWriter writer;
	
   public AbstractXMLStreamWriterAdapter(XMLStreamWriter writer) {
	...
	/**
	 * As per common writer, Does nothing intentionally
	 * metadata writer requires to be able to write,
	 * so it must be implemented in the subclass
	 */
/*	@Override
	...
	/**
	 * As per common writer, Intentionally does nothing, to block writing namespace URLs 
	 * Metadata writer needs it to write,
...
/*	@Override
	 ...
	 * (NOT PART OF the XMLWriter Interface)
	 * 
	 * @param prefix
	 * @param namespaceURI
	 * @throws XMLStreamException
