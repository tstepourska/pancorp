 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ResCountryCode" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class OrganisationPartyType {
    ...
    protected List<String> resCountryCode;
    @XmlElement(name = "TIN")
     ...
     * 
     */
    public List<String> getResCountryCode() {
        if (resCountryCode == null) {
            resCountryCode = new ArrayList<String>();
        }
