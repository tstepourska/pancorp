...
<head>
<meta charset="utf-8"/>
<title>Service unavailable / Service indisponible</title>
...
<h2 class="h3">Service unavailable</h2>
<p>The requested service is currently unavailable due to maintenance or a higher than expected load.</p>
<p>We regret the inconvenience. Please try again later.</p>
<ul>
<li><a href="http://www.cra-arc.gc.ca/menu-eng.html">Home</a></li>
<li><a href="javascript:history.go(-1)">Previous page</a></li>
</ul>
</section>
<section class="col-md-6" lang="fr">
<h2 class="h3">Service indisponible</h2>
<p>Le service demandé est actuellement indisponible en raison des travaux d'entretien ou d'une utilisation plus élevée que prévue.</p>
<p>Nous regrettons cet inconvénient. Veuillez essayez de nouveau plus tard.
</p>
<ul>
<li><a href="http://www.cra-arc.gc.ca/menu-fra.html">Accueil</a></li>
