...
//! [ewrapperimpl]
public class CancelOrderEWrapperImpl implements EWrapper {
	private static Logger lg = LogManager.getLogger(CancelOrderEWrapperImpl.class);
	...
	//! [socket_init]
	public CancelOrderEWrapperImpl(CancelOrder co) {
		cancelOrder = co;
...
/*	public void setOrder(Order order) {
	...
	/*public int getCurrentOrderId() {
	 ...
	 //! [tickprice]
	/**
	 * Callback method for reqTomMarketData()
	 */
	@Override
	...
	public void orderStatus(int orderId, String status, double filled,
		...
		int sqlStatus = dfac.updateOrder(orderId, status, filled, remaining, avgFillPrice, lastFillPrice);
		lg.info("orderStatus: updated: " + sqlStatus);
		//TODO
		switch(status){
		case "PreSubmitted":
			break;
		case "Filled":
			//TODO handle no cancel case
			break;
		case "Cancelled":
			//TODO this one?
	...
	public void nextValidId(int orderId) {
		...
		//this.cancelOrder.setNextOrderId(orderId);
	}
	//! [nextvalidid]
