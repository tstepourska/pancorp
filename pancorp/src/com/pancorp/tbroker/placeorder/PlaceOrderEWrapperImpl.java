...
//! [ewrapperimpl]
public class PlaceOrderEWrapperImpl implements EWrapper {
	private static Logger lg = LogManager.getLogger(PlaceOrderEWrapperImpl.class);
	
	//! [ewrapperimpl]
	
	//! [socket_declare]
	private PlaceOrderBracket placeOrderBracket;
	...
	//! [socket_init]
	public PlaceOrderEWrapperImpl(PlaceOrderBracket opb) {
		placeOrderBracket = opb;
